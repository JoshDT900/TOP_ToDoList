"use strict";
(self["webpackChunktop_todolist"] = self["webpackChunktop_todolist"] || []).push([["object_functions"],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "dataObjArr": () => (/* reexport safe */ _pagecontrol_js__WEBPACK_IMPORTED_MODULE_1__.dataObjArr),
...
/* harmony import */ var _displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./displayfuncs.js */ "./src/displayfuncs.js");
/* harmony import */ var _datafile__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./datafile */ "./src/datafile.js");
...
let profileBox = () => {
    ...
    projBtnEle.addEventListener("click", _displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__.formShow);
...
let sideNavBox = () => {
    ...
    let eventArr = [_displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__.showTodaysTasks, _displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__.showWeekTasks, _displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__.showMonthTasks, _displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__.showAllTasks];
    ...
    for (let i in navClassArr) {
        ...
        newEle.addEventListener("click", () => {
            ...
            (0,_displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__.clearTasks)();
            mainContBox(eventFunc(_pagecontrol_js__WEBPACK_IMPORTED_MODULE_1__.dataObjArr));
        })
...
let formBox = () => {
    ...
    formBoxEle.addEventListener("submit", (event) => {
        ...
        (0,_pagecontrol_js__WEBPACK_IMPORTED_MODULE_1__.formController)();
    });
    ...
    for (let i = 0; i < formEleClassArr.length; i++) {
        ...
        if (formEleClassArr[i] === "proj_name_box"){
            ...
            cancelBtnEle.addEventListener("click", () => {
                (0,_displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__.formHide)();
                (0,_displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__.formRemove)(formBoxEle);
            })
...
let mainContBox = (arr) => {
    ...
    for (let obj of arr) {
        ...
        let timeEle = domGenModule.makeEle("div", ["class", "todo_time"], (0,_pagecontrol_js__WEBPACK_IMPORTED_MODULE_1__.formatDate)(obj));
        ...
        for (let i = 0; i < btnImgArr.length; i++) {
            ...
            if (btnClassArr[i] === "todo_delete") {
                ...
                newBtn.addEventListener("click", () => {(0,_pagecontrol_js__WEBPACK_IMPORTED_MODULE_1__.editTask)(_pagecontrol_js__WEBPACK_IMPORTED_MODULE_1__.dataObjArr, obj.id)});
                btnImgEle.setAttribute("task_id", obj.id);
            }

            (0,_displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__.swapImg)(btnImgEle, _images_js__WEBPACK_IMPORTED_MODULE_2__.completedTaskImg, _images_js__WEBPACK_IMPORTED_MODULE_2__.completedTaskImgFilled);
...
(function() {    
    ...
    (0,_datafile__WEBPACK_IMPORTED_MODULE_4__.loadData)(localStorage.getItem(`projects`));
    mainContBox((0,_displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__.showTodaysTasks)(_pagecontrol_js__WEBPACK_IMPORTED_MODULE_1__.dataObjArr));
})();
...
/* harmony export */ });
/* harmony import */ var _pagecontrol_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pagecontrol.js */ "./src/pagecontrol.js");
...
const taskFactory = (formData) => {
    ...
    let tasks = {};
    let prio = 0;    
    let id = idGen(_pagecontrol_js__WEBPACK_IMPORTED_MODULE_0__.dataObjArr);
    let complete = false;    
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "dataObjArr": () => (/* reexport safe */ _datafile_js__WEBPACK_IMPORTED_MODULE_2__.dataObjArr),
...
/* harmony import */ var _objectfuncs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./objectfuncs.js */ "./src/objectfuncs.js");
/* harmony import */ var _datafile_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./datafile.js */ "./src/datafile.js");
/* harmony import */ var _displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./displayfuncs.js */ "./src/displayfuncs.js");
...
let formController = () => {
    ...
    if (document.querySelector(".submitBtn").innerHTML === "Add Project"){
        newDomTask(formVals);
        (0,_displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__.formHide)();
        (0,_displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__.formRemove)(formDisplay);
        return;
...
let formatDate = (obj) => {
    ...
    let formatedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(dateArr[2], parseInt(dateArr[1]) - 1, dateArr[0], parseFloat(dateArr[3][0]), parseFloat(dateArr[3][1])), "MMM dd yyyy - p");

    return formatedDate;
}

let newDomTask = (obj) => {
    let newObj = (0,_objectfuncs_js__WEBPACK_IMPORTED_MODULE_1__.taskFactory)(obj);

    _datafile_js__WEBPACK_IMPORTED_MODULE_2__.dataObjArr.push(newObj);        
    (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.mainContBox)(_datafile_js__WEBPACK_IMPORTED_MODULE_2__.dataObjArr.slice(-1));
    (0,_datafile_js__WEBPACK_IMPORTED_MODULE_2__.saveProjLoc)(_datafile_js__WEBPACK_IMPORTED_MODULE_2__.dataObjArr)
...
let removeTaskObj = (eleId) => {
    console.log(eleId);
    let newObjArr = _datafile_js__WEBPACK_IMPORTED_MODULE_2__.dataObjArr.filter(test => test.id != eleId);
    console.log("item removed");

    return (0,_datafile_js__WEBPACK_IMPORTED_MODULE_2__.saveProjLoc)(newObjArr); 
}
...
let editTask = (obj, taskId) => {
    ...
    (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.formBox)();
    (0,_displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__.formShow)();    
...
let replaceTask = (id) => {
    let newObjArr = _datafile_js__WEBPACK_IMPORTED_MODULE_2__.dataObjArr.filter(obj => id !== obj.id)

    ;(0,_displayfuncs_js__WEBPACK_IMPORTED_MODULE_3__.clearTasks)();
    
    (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.mainContBox)(newObjArr);
    (0,_datafile_js__WEBPACK_IMPORTED_MODULE_2__.saveProjLoc)(newObjArr);
